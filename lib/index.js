...
class Payworks extends EventEmitter {
  constructor (options) {
    ...
    this.default = {}
    this.user && (this.default.user = options.user)
    this.password && (this.default.password = options.password)
    this.merchant_id && (this.default.merchant_id = options.merchant_id)
    this.terminal_id && (this.default.terminal_id = options.terminal_id)
  }
